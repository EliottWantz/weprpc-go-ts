...
//
// webrpc-gen -schema=example.ridl -target=golang -pkg=service -server -out=./service/exemple.gen.go
package service
...
func WebRPCSchemaHash() string {
	return "1951e8dd141fb960d078e48deeb46211fa46041a"
}
...
func (s *userServiceServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	switch r.URL.Path {
	case "/rpc/UserService/Ping":
		s.servePing(ctx, w, r)
		return
	case "/rpc/UserService/CreateUser":
		s.serveCreateUser(ctx, w, r)
		return
	case "/rpc/UserService/GetUserByID":
...
func (s *userServiceServer) servePing(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (s *userServiceServer) servePingJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.UserService.Ping(ctx)
	}()
	respContent := struct {
...
func (s *userServiceServer) serveCreateUser(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *userServiceServer) serveCreateUserJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.UserService.CreateUser(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
		Ret0 *User `json:"user"`
	}{ret0}
...
func (s *userServiceServer) serveGetUserByID(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *userServiceServer) serveGetUserByIDJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.UserService.GetUserByID(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 *User `json:"user"`
	}{ret0}
...
func (s *userServiceServer) serveListUsers(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *userServiceServer) serveListUsersJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.UserService.ListUsers(ctx)
	}()
	respContent := struct {
